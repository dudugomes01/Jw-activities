...
export function ProgressSummary({ activities }: ProgressSummaryProps) {
  ...
  // Filtra atividades apenas do mês atual
  ...
  // Calcula o total de horas apenas das atividades do mês atual
  const totalMonthHours = calculateTotalHours(currentMonthActivities);
  ...
  // Total de atividades do mês atual
